...
class collaborateurs(models.Model):
    ...
    formation = models.ManyToManyField(obtentionFormation, blank=True, verbose_name='Formations & Certifications')
...
class projet(models.Model):
    ...
    BUProjet = models.ForeignKey(BU, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='BU rattaché au projet', help_text='Indiquez le nom de la BU s’il s’agit d’une mission Thémis')
